...
class MeetingsRepositoryMock: MeetingsRepository {
    ...
    let oliver = User(id: "oliver.lazoroski@getstream.io", name: "Oliver", imageURL: URL(string: "https://getstream.io/static/712bb5c0bd5ed8d3fa6e5842f6cfbeed/c59de/tommaso.webp"), extraData: [:])
